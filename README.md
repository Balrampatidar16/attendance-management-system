...
Now open backend/.env and fill in the values — see section 2 below.
...
cd backend
npm run seed
This wipes and repopulates the database with 1 admin, 2 managers, 6 employees, and ~30 days of sample attendance. Login credentials are printed in the terminal and also listed in section 5.
...
Run npm run seed first (see section 1). All accounts use the same password.
